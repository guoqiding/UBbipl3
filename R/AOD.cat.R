...
function (X = Ocotea.cat[, 3:8], group.vec = 1:37, exp.factor = 1.2, 
    ...
    legend.plot = FALSE, CLP.PointsInPredRegs = TRUE, CLP.LabelsInPredRegs = TRUE, 
    region.colours = c("pink", "orange", "yellow", "cyan", "grey"), 
    sample.labels = TRUE, sample.labels.cex = 0.7, text.size = c(1, 
        1), colours = UBcolours, cij.null = FALSE, predict.samples = NULL, 
    labels = NULL, CLP.multiplier = 1, jitter = FALSE, jitter.factor = 5) 
{
