...
function (Z, z.axes, z.axes.names = NULL, p, ax = NULL, ax.col, 
    ...
    conf.alpha = NULL, conf.type = NULL, conf.ellipse = NULL, 
    ...
    Tukey.median = TRUE, Z.means.mat, zoomval) 
{
    ...
    else plot(Z[, 1] * exp.factor, Z[, 2] * exp.factor, xlim = zoomval[1:2], 
    ...
    if (means.plot == TRUE & large.scale == TRUE) {
        ...
        predictions <- .axes.plot(Z = Z, z.axes = z.axes, z.axes.names = z.axes.names, 
